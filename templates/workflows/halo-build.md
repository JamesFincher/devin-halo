...
- Read the **Post-Run Critiques** from the **last 3 cycles** in `STATE.md` — treat them as **instructions for this cycle**, not just logs. The most recent critique is directional ("do X next cycle"); earlier critiques provide compounding context.
